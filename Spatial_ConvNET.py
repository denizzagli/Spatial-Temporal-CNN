# Spatial Convolutional Neural Network tasks took place in this file.
...
# Paths containing the frames required for spatial CNN and the labels of the frames are accessed with this function.
...
# Images in paths are converted to numpy array. It has 3 channels: Red, Green, Blue.
